...
export default function Footer() {
  return (
    <footer className="relative bg-black border-t border-purple-500/20 mt-20">
      <div className="h-0.5 w-full bg-gradient-to-r from-transparent via-purple-500/50 to-transparent" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-1">
            ...
            <div className="font-rajdhani text-purple-400 tracking-[0.3em] text-sm mb-4">GUILD</div>
          ...
          {/* Links */}
          <div>
            <h4 className="font-orbitron text-xs text-purple-400 tracking-widest uppercase mb-4">Platform</h4>
            <ul className="flex flex-col gap-2">
              {[['/', 'Home'], ['/apply', 'Apply'], ['/auth/login', 'Login'], ['/auth/register', 'Register']].map(([href, label]) => (
                <li key={href}>
                  <Link href={href} className="text-slate-500 hover:text-purple-300 text-sm font-rajdhani tracking-wide transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="font-orbitron text-xs text-purple-400 tracking-widest uppercase mb-4">Guild</h4>
            <ul className="flex flex-col gap-2">
          ...
          <div>
            <h4 className="font-orbitron text-xs text-purple-400 tracking-widest uppercase mb-4">Status</h4>
